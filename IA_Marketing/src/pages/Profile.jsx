...
const Profile = () => {
  ...
  const handleUpdate = async () => {
    try {
      const { nombre, apellido, empresa } = editFormData;
      const response = await axios.post(`http://localhost:5000/api/usuarios/editar/${idCliente}`, {
        empresa,
        nombre,
        apellido,
      });
      if (empresa && nombre && apellido) {
        ...
        alert('No se pudo actualizar. Intente de nuevo completando todos los campos.');
      }
    } catch (error) {
  ...
  return (
    <>
      <div>
        ...
        <div className="mt-3 rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
          ...
          <div className="p-7">
            <form action="#">
              <div className="mb-5.5 flex flex-col gap-5.5 sm:flex-row">
                <div className="w-full sm:w-1/2">
                  ...
                  <div className="relative">
                    ...
                    <input
                      name="nombre" value={editFormData.nombre || ''} onChange={handleInputChange}
                ...
                <div className="w-full sm:w-1/2">
                  ...
                  <div className="relative">
                    ...
                    <input
                      name="apellido" value={editFormData.apellido || ''} onChange={handleInputChange}
                      className="w-full rounded border border-stroke bg-gray py-3 pl-11.5 pr-4.5 text-black focus:border-primary focus-visible:outline-none dark:border-strokedark dark:bg-meta-4 dark:text-white dark:focus:border-primary"
                      type="text"
                      id="fullName"
              ...
              <div className="mb-5.5">
                ...
                <input
                  name="empresa" value={editFormData.empresa || ''} onChange={handleInputChange}
              ...
              <div className="flex justify-end gap-4.5">
                <button
                  className="flex justify-center rounded border border-stroke py-2 px-6 font-medium text-black hover:shadow-1 dark:border-strokedark dark:text-white hover:bg-slate-50"
                  type="submit"
                >
                  Cancelar
                </button>
                <button
                  ...
                  className="flex justify-center rounded bg-orange-400 hover:bg-orange-500 py-2 px-6 font-medium text-gray hover:shadow-1"
                  type="submit"
                >
                  Guardar
                </button>
