                ...
                <div className=" flex justify-around mt-16">
                  <div className="mb-5">
                    <input
                      type="submit"
                      value="Crear cuenta"
                      className="w-96 cursor-pointer rounded-lg border border-warning bg-orange-400 p-4 font-bold text-white transition hover:bg-opacity-90 hover:bg-orange-500"
                    />
                  </div>
                </div>
              </form>
