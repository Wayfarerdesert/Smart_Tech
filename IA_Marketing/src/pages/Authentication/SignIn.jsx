...
const SignIn = () => {
  // Crear cuenta redirige a signup
  ...
  const [isFormValid, setIsFormValid] = useState(true); // Nuevo estado para controlar la validez del formulario
  ...
  // Manejar el evento onBlur para validar el email
  const handleEmailBlur = () => {
    const isValidEmail = validateEmail(email);
    setShowAlert(!isValidEmail); // Mostrar alerta si el email no es válido
  };

  return (
    <>
      <div className="rounded-sm  bg-white shadow-default  dark:bg-boxdark mt-56 h-screen">
        <div className="flex flex-wrap items-center">
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2 pr-24 pl-10">
